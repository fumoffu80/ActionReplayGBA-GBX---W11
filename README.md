...
<p align="center">
  <img src="1652865_org.jpg" alt="Action Replay GBA" width="400">
</p>
...
> **Version la plus récente du projet : v1.2.16**
>
...
- Affichage de métadonnées et, selon la version, jaquette du jeu.
- Sauvegarde et restauration des sauvegardes GBA.
...
Le projet est écrit principalement en **Go**.

### `gui/`
Interface graphique Windows.

Elle orchestre les opérations, présente les bases de codes, les informations du périphérique, les fonctions de sauvegarde et les avertissements de sécurité.

### `engine/`
Moteur bas niveau et logique du protocole USB.

Il gère notamment :

- découverte du périphérique WinUSB ;
- commandes USB Datel ;
- lecture/écriture des bases de codes ;
- sauvegardes GBA ;
- dump Flash ;
- validation et écriture firmware.

### `driver/`
Installation et récupération du pilote WinUSB sous Windows moderne.

### `setup/`
Installateur/désinstallateur Windows.
...
Le dump complet n’est **pas redistribué** dans ce dépôt. Seuls les résultats techniques dérivés sont documentés.

### Empreintes de l’échantillon privé v4.0

Dump complet 256 Kio :

```text
CRC32   9270A4E7
MD5     6d9f1890063293e350462dddbc328433
SHA-1   d8acb5383d3dc42f9af9b7d3d5685751f9a00fb0
SHA-256 63291f759e0e6fa6fe8dd1c99c8234ab8ad1b8385d294e6e14d6814205cbfe9a
```

Moitié système 128 Kio :

```text
CRC32   5D5C8EC3
SHA-256 1e93c9aa3208d7ef46577dd0e86255894cf661bae63325bd7dc9f0055893395e
```
...
Prérequis principal : **Go 1.23+**.

Structure :

```text
engine/   moteur USB / CLI
driver/   gestion WinUSB
gui/      interface graphique
setup/    installateur
```

Consulter également `BUILD-SOURCES.txt` lorsqu’il est présent dans la version concernée.
...
```text
gui/      Windows GUI
engine/   USB protocol / command engine
driver/   WinUSB installation and recovery
setup/    Windows installer/uninstaller
```

The low-level engine is responsible for USB discovery, Datel commands, code databases, GBA saves, Flash dumping and firmware validation/writing.
...
The full binary is **not redistributed** in this repository.

### Private v4.0 sample fingerprints
...
Proprietary Datel firmware is not intentionally redistributed here without an appropriate legal basis. The analyzed v4.0 dump remains a **private research sample**; only hashes and derived technical observations are published.
